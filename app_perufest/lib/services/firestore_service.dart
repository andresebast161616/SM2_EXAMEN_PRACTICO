...
import 'historial_sesion_service.dart';
...
class FirestoreService {
  ...
  static final _historialService = HistorialSesionService();
  ...
  static Future<Usuario?> loginUsuario(String correo, String contrasena) async {
    ...
    if (query.docs.isNotEmpty) {
      ...
      if (coincide) {
        ...
        await _historialService.registrarInicioSesion(
          userId: usuario.id,
          usuario: usuario.username.isNotEmpty ? usuario.username : usuario.correo,
        );
        print('📊 Historial de sesión registrado');
